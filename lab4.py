...
while True:
    ...
    # 1. Meminta input data dari pengguna
    nama = input("Nama Mahasiswa : ")
    nim = input("NIM Mahasiswa  : ")
    
    # Gunakan try-except untuk memastikan input nilai adalah angka
    try:
